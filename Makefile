...
docker:
	docker build --force-rm -t "docker.stackable.tech/stackable/druid-operator:${VERSION}" -t "docker.stackable.tech/stackable/druid-operator:latest" -f docker/Dockerfile .
