...
Kubernetes operator for Apache Druid. Deploy and run Druid clusters with the Stackable Data Platform (SDP).
...
```bash
helm install druid-operator oci://oci.stackable.tech/sdp-charts/druid-operator
```
...
- `oci://oci.stackable.tech/sdp-charts/druid-operator`
- `oci://quay.io/stackable/sdp-charts/druid-operator`
...
See the [documentation](https://docs.stackable.tech/home/stable/druid/) for the full picture.

## Custom resources

This operator installs and manages its own CustomResourceDefinitions, so they are not part of this chart.
The resources it reconciles, and the configuration they accept, are described in the [documentation](https://docs.stackable.tech/home/stable/druid/).Each CRD is also browsable on the [Stackable Hub](https://hub.stackable.tech/components/druid), with its schema and the API versions served per SDP release.
## Links

- [Documentation](https://docs.stackable.tech/home/stable/druid/)
- [Stackable Hub](https://hub.stackable.tech/)
- [Source](https://github.com/stackabletech/druid-operator)
- [Report an issue](https://github.com/stackabletech/druid-operator/issues)
- [Stackable Data Platform](https://stackable.tech/)

## License

[Open Software License version 3.0](https://github.com/stackabletech/druid-operator/blob/main/LICENSE)
