...
- BREAKING: Reworked top level configuration. Deep storage, Ingestion spec, discovery config maps, authtication etc. are now subfields of `spec.clusterConfig` instead of being top level under `spec` ([#333], [#373])
