...
xref:first_steps.adoc[Set up a Druid cluster] and its dependencies and xref:first_steps.adoc#_ingest_example_data[ingest example data] and xref:first_steps.adoc#_query_the_data[query the data].