...
Meaning the overlord will not send any new tasks and the middle manager will terminate after all tasks are finished or the termination grace period is exceeded.
