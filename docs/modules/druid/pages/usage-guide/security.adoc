...
Druid supports xref:concepts:authentication.adoc[authentication] of users of the web console against an OIDC provider.
This requires setting up an xref:concepts:authentication.adoc#authenticationclass[AuthenticationClass] for the OIDC provider:
