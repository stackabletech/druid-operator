...
can try out interactively. Both demos below include Druid as part of the data pipeline:
...
The xref:demos:nifi-kafka-druid-earthquake-data.adoc[] demo ingests https://earthquake.usgs.gov/[earthquake data]
