...
----
include::example$getting_started/getting-started.sh[tag=install-hdfs]
----
...
----
include::example$getting_started/getting-started.sh[tag=install-druid]
----
...
[source,bash]
include::example$getting_started/getting-started.sh[tag=submit-job]
...
[source,bash]
include::example$getting_started/getting-started.sh[tag=query-data]
