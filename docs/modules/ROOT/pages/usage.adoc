...
By enabling LDAP, the nodes will try to use LDAP to communicate among themselves. This will effectievly override and disable the TLS authentication method at the current moment.
