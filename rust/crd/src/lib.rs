...
pub struct DruidClusterConfig {
    ...
    pub additional_extensions: Option<AdditionalExtensionsConfig>,
...
#[derive(Clone, Debug, Deserialize, JsonSchema, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct AdditionalExtensionsConfig {
    /// Extensions that should be loaded in addition to the default list of extensions generated by the operator.
    /// Add configuration for custom extensions using [configuration overwrite for Druid](https://docs.stackable.tech/home/stable/druid/usage-guide/configuration-and-environment-overrides).
