...
use stackable_druid_crd::{DruidCluster, DruidRole};
...
use crate::{druid_controller::druid_version, APP_NAME, APP_PORT};
...
pub async fn build_discovery_configmaps(
    ...
    let name = owner.name();
    Ok(vec![
        build_discovery_configmap(&name, owner, druid, chroot, pod_hosts(zk)?)?,
