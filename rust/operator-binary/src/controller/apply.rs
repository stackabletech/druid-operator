...
use super::{types::BuiltClusterResource, CONTROLLER_NAME};
...
pub async fn apply_cluster_resources(
    ...
    appliable_cluster_resources: Vec<BuiltClusterResource>,
) -> Result<Action> {
    ...
    for cluster_resource in appliable_cluster_resources {
        match cluster_resource {
            ...
            BuiltClusterResource::DiscoveryConfigMap(config_map) => {
                cluster_resources
            ...
            BuiltClusterResource::InternalSecret(secret) => {
