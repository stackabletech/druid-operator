...
//! `smooth-operator` branch, with simplifications appropriate for druid-operator.
//!
...
//!   implement `Merge`. Druid uses `JavaCommonConfig`, which intentionally does not
...
/// Druid-friendly view of a validated, merged `RoleGroup`.
